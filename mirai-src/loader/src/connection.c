...
{
    //printf("connection.c::connection_close()\n");
    ...
    if (conn->open) {
        ...
        if (conn->success) {
            ...
            fprintf(stderr, "OK! IP: %d.%d.%d.%d, Port: %d, Auth: %s:%s, Arch: %s\n",
            ...
            fprintf(stderr, "Error. IP: %d.%d.%d.%d, Port: %d, Auth: %s:%s, Arch: %s - Telnet state: %d\n",
                    conn->info.addr & 0xff, (conn->info.addr >> 8) & 0xff, (conn->info.addr >> 16) & 0xff, (conn->info.addr >> 24) & 0xff,
                    ntohs(conn->info.port),
                    conn->info.user, conn->info.pass, conn->info.arch,
                    conn->state_telnet);
...
{
    //printf("connection.c::connection_consume_iacs()\n");
...
{
    //printf("connection.c::connection_consume_login_prompt()\n");
...
{
    //printf("connection.c::connection_consume_password_prompt()\n");
...
{
    //printf("connection.c::connection_consume_prompt()\n");
...
{
    //printf("connection.c::connection_consume_verify_login()\n");
...
{
    //printf("connection.c::connection_consume_psoutput()\n");
...
{
    //printf("connection.c::connection_consume_mounts()\n");
...
{
    //printf("connection.c::connection_consume_written_dirs()\n");
...
{
    //printf("connection.c::connection_consume_copy_op()\n");
...
{
    //printf("connection.c::connection_consume_arch()\n");
...
{
    //printf("connection.c::connection_consume_arm_subtype()\n");
...
{
    //printf("connection.c::connection_consume_upload_methods()\n");
...
{
    //printf("connection.c::connection_upload_echo()\n");
...
{
    //printf("connection.c::connection_upload_wget()\n");
...
{
    //printf("connection.c::connection_upload_tftp()\n");
...
{
    //printf("connection.c::connection_verify_payload()\n");
...
{
    //printf("connection.c::connection_consume_cleanup()\n");
